...
class penerimaanPbbModel extends Model
{
    ...
    protected $allowedFields = ['nomor_objek_pajak', 'nama_wajib_pajak', 'tahun', 'total_pbb_dibayar', 'gambar', 'created_at', 'updated_at', 'deleted_at'];
    ...
    public function button()
    {
        $aksi_button = function ($row) {
            if (in_groups('admin')) {
                return '
                <button type="button" name="edit" class="btn btn-warning btn-sm edit4" data-id="' . $row["id_pbb"] . '">Edit</button>&nbsp;
