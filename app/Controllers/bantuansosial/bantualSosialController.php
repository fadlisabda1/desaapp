...
class bantuanSosialController extends BaseController
{
    ...
    {
        $bantuanSosial = [
            'title' => 'Administrasi Umum | Bantual Sosial'
        ];
        return view('administrasiumum/bantuanSosialView', $bantuanSosial);
    }
    ...
    public function ambilData()
    {
        ...
        $data_table->setTable($this->bantuanSosialModel->getDataNull())
            ...
            ->setOutput([$this->bantuanSosialModel->ceklisDelete(), 'nomor_tgl_peraturan', 'tentang', 'uraiansingkat', $this->bantuanSosialModel->button()]);
