...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-success shadow-sm fixed-top">
        <div class="container">
            <a class="navbar-brand page-scroll" href="#tes"><img src="gambar/LogoKampar.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top"><span class="text-wrap badge bg-success" style="width:14rem">Desa Tanah Merah Kabupaten Kampar</span></a>
