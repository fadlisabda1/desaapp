...
<div class="card shadow mb-4 mt-4">
    <?php if (in_groups('admin')) : ?>
        <div class="card-header py-3">
            <button type="button" class="btn tambahPeraturan" data-bs-toggle="modal" data-bs-target="#formModal" style="color:white;background-color: rgb(48,123,109);">
                Tambah
            </button>
    ...
    <div class="card-body">
        <div class="table-responsive mt-2">
            <table id="tablePeraturan" class="table table-bordered table-hover">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="formImportPeraturan" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    <div class="mb-3">
...
<div class="modal fade" id="formModal" tabindex="-1" aria-labelledby="judulModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" id="formPeraturan">
                    <?= csrf_field(); ?>
